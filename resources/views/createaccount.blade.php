                ...
                <div class="py-8">
                    <form class="mt-8 max-w-sm mx-auto" method="post" action="/user">
                        ...
                        <label class="block mt-3">
                            ...
                            <input type="text" name="role" id="role" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="owner atau penyewa" required>
                        </label>
