...
<!-- Hero section -->
    <section class="bg-white dark:bg-gray-900 py-8">
        <div class="flex flex-col md:flex-row justify-between gap-10 text-center md:text-left">
            ...
            <div class="flex-1">
                <img class="rounded-2xl" src="https://pbs.twimg.com/media/GBJPcklbUAAL95O?format=webp" alt="Kos Tipayung 2">
            </div>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <p class="text-gray-900 dark:text-white text-lg flex justify-between">Harga <span class="font-semibold">Rp {{ number_format($data->price, 0, ',', '.') }}</span></p>
